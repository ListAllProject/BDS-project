        ...
        <div className="cart">
          <span className="product-list">
            ...
            <div className="product-item">
              ...
              <span className="product-location">
                <div style={{ fontSize: 14, fontWeight: 700 }}>Căn hộ S1.092205 - Tòa S1.09</div>
                <div style={{ fontSize: 12, fontWeight: 400 }}>Vinhomes Ocean Park</div>
              </span>
              <span className="product-area">
                <div style={{ fontSize: 14, fontWeight: 700 }}>Diện tích</div>
                <div style={{ fontSize: 18, fontWeight: 700 }}>63m<sup>2</sup></div>
              </span>
              ...
              <span className="product-price">
                ...
                <div style={{ fontSize: 18, fontWeight: 700 }}>2.613.359.000</div>
              </span>
          ...
          <span className="checkout">
            <div className="wrap-checkout-content">
              <div className="price">
                <span style={{ marginRight: '5px', fontSize: 12, fontWeight: 400, display: 'flex', alignItems: 'center' }}>Giá BĐS niêm yết<i className="fas fa-info-circle clickable" /></span>
                <span style={{ fontSize: 18, fontWeight: 700 }}>2.613.359.000đ</span>
              </div>
              <div className="evoucher">
                <Input suffix={<i className="fas fa-info-circle clickable" />} placeholder="Nhập mã E-voucher" addonAfter={<div>ÁP DỤNG</div>}></Input>
              </div>
              <div className="total-price">
                <span style={{ fontSize: 12, fontWeight: 400, display: 'flex', alignItems: 'center' }}>Tổng tiền mua online</span>
                <span style={{ fontSize: 18, fontWeight: 700 }}>2.613.359.000đ</span>
              </div>
